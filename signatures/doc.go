...
Package signatures provides the configuration settings for different
 services. These are the settings that get set on the base machine.

Documentation that was used to build this tool:
